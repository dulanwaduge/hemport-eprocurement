                        ...
                        <div class="table-responsive">
                            <table border="3" cellspacing="0" cellpadding="3">
                                ...
                                <tr style="font-size:4">
                                    ...
                                    <th><?= $this->Paginator->sort('', 'Product details') ?></th>
                                </tr>
                                ...
                                foreach ($orderplaced as $orderplaced): ?>
                                    <tr>
                                        ...
                                        <td><a href="<?= $this->Url->build(['controller' => 'product', 'action'=>'view', $orderplaced->product_id]); ?>">Click here to go to Product Page on site</a></td>
                                        <td><a href="<?= $this->Url->build(['controller' => 'product', 'action' => 'edit', $orderplaced->product_id]); ?>">Click here to view Product in Dashboard</a></td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
                            </table>
                ...
                <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body" style="margin-left: 25px;">Select "Delete" below if you are ready to end your current session. <p style='font-size:14px'>*The account can not be recovered and your related project will be deleted too.</p></div>
                            <div class="modal-footer">
