        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <?= $this->Form->control('key', [
                    ...
                    'placeholder'=>'Search by username/user type'])
                ?>
                    ...
                    <div class="table-responsive">
                        <table border="3" cellspacing="0" cellpadding="3">
                            ...
                            <tr>
                                ...
                                <th><?= $this->Paginator->sort('modifiedate') ?></th>
                            ...
                            <?php foreach ($users as $key => $user): ?>
                                <tr>
                                    ...
                                    <td><?= h($user->modifiedate) ?></td>
                                    <td class="actions">

                                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $user->id],['class'=>'fas fa-edit']) ?>
                                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $user->id], ['class'=>'fas fa-trash','confirm' => __('Are you sure you want to delete {0}?', $user->username)]) ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
