                ...
                <div class="row">
                    ...
                    <div class="column-responsive column-80">
                        <div class="users form content">
                            ...
                            <fieldset>
                                <?php
                                echo $this->Form->control('username',['style'=>'margin-bottom:15px']);

                                echo "Account Type";
                                echo $this->Form->select('type',['Buyer'=>'Buyer','Seller'=>'Seller','Builder'=>'Builder(Professional)'],['style'=>'margin-left:82px']);

                                ?>
                            </fieldset>
                            <?= $this->Form->button(__('Submit'),['style'=>'margin-top:20px']) ?>
                            <button class="back-btn " ><a  href="<?= $this->Url->build(['controller' => 'Users', 'action'=>'index']); ?>" style="color: white;">Back </a>    </button>
                            <?= $this->Form->end() ?>
                        </div>
                    </div>
