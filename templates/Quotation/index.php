        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="row d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">View Listed Quotation</h1>
                        ...
                        <div class="table-responsive">
                            <table border="3" cellspacing="0" cellpadding="3">
                                ...
                                foreach ($quotation as $q): ?>
                                    <tr>
                                        <td><?= $i; ?></td>
                                        <td><?= $q->status == 0 ? 'NO' : 'YES'; ?></td>
                                        <td><?= h($q->company_name) ?></td>
                                        <td><?= h($q->abn) ?></td>
                                        <td><?= h($q->email) ?></td>
                                        <td><?= h($q->contact_number) ?></td>
                                        <td><?= h($q->description) ?></td>
                                        <td><?= h($q->create_time) ?></td>
                                        <?php if ($type == 'Buyer') { ?>
                                            <td class="actions">
                                                <?= $this->Form->postLink(__('Select'), ['action' => 'select', $q->id], ['class'=>'fas fa-edit','confirm' => __('Are you sure you want to select {0} quotation ?', $q->company_name)]) ?>
                                            </td>
                                        <?php } ?>
                                        <?php if ($type == 'Seller'|| $type == 'Admin') { ?>
                                        <td class="actions">
                                            <?= $this->Html->link(__('Edit'), ['action' => 'edit', $q->id],['class'=>'fas fa-edit']) ?><br>
                                            <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $q->id], ['class'=>'fas fa-trash','confirm' => __('Are you sure you want to delete {0} quotation ?', $q->company_name)]) ?>
                                        </td>
                                        <?php } ?>
                                    </tr>
                                    <?php $i++; endforeach; ?>
