        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="<?= $this->Url->build(['controller' => 'projects', 'action'=>'add']); ?>">Add New Project</a>
                </div>
            </div>
        </li>
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Listed Projects</h1>
                ...
                <div class="product index content">
                    ...
                    <div>
                        ...
                        <div style="float: left;margin-bottom:12px">
                            <button><?= $this->Html->link(__('Add New Project'), ['action' => 'add'], ['class' => 'btn']) ?></button>
                        </div>
                            ...
                            <table border="3" cellspacing="0" cellpadding="3">
                                ...
                                foreach ($projects as $projects): ?>
                                    <tr>
                                        ...
                                        <td class="actions">
                                            <?= $this->Html->link(__('Edit'), ['action' => 'edit', $projects->id],['class'=>'fas fa-edit']) ?>
                                            <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $projects->id], ['class'=>'fas fa-trash','confirm' => __('Are you sure you want to delete # {0}?', $projects->id)]) ?>
                                        </td>
                                    </tr>
                                    <?php $i++; endforeach; ?>
                                </tbody>
