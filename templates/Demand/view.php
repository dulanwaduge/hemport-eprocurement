        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">View Demand</h1>
                ...
                <div class="column-responsive column-80">
                    <div class="seller form content">
                        ...
                        <fieldset>
                            <?php
                            echo $this->Form->control('demand',['label'=>'Demand(*)', array('type' => 'text','readonly' => 'readonly')]);
                            echo $this->Form->control('amount',['label'=>'Demand Quantity(*)', array('type' => 'text','readonly' => 'readonly')]);
                            echo '<div class="row" style="margin-left:0.8px">';
                            echo 'Demand Description(*)';
                            echo $this->Form->textarea('description', ['style'=>'margin-left:15px; margin-bottom:6px; width:194px', array('type' => 'text','readonly' => 'readonly')]);
                            echo '</div>';

                            echo $this->Form->control('business_num',['label'=>'Business Contact Number(*)', array('type' => 'text','readonly' => 'readonly')]);
                            echo $this->Form->control('business_email',['label'=>'Business Email(*)', array('type' => 'text','readonly' => 'readonly')]);
                            echo $this->Form->control('business_address',['label'=>'Business Address(*)', array('type' => 'text','readonly' => 'readonly')]);
                            echo $this->Form->control('city',['label'=>'City(*)', array('type' => 'text','readonly' => 'readonly')]);
                            echo 'State';
                            echo $this->Form->select('state',['ACT'=>'ACT','NSW'=>'NSW','NT'=>'NT','Qld'=>'QLD','SA'=>'SA','Vic'=>'VIC','Tas'=>'TAS','WA'=>'WA'], ['style'=>'margin-left:140px;margin-bottom: 5px;', array('type' => 'text','readonly' => 'readonly')]);
                            echo $this->Form->control('postcode',['label'=>'Postcode(*)', array('type' => 'text','readonly' => 'readonly')]);
                            echo $this->Form->control('ABN',['label'=>'ABN(*)', array('type' => 'text','readonly' => 'readonly')]);
                            ?>
                        </fieldset>
