...
<div class="container">
    ...
    <h2 style="text-align: center; font-family: Poppins, sans-serif;">Payment Details</h2><br/>
            ...
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <?= $this->Form->create(null, [
                        "action" => $this->Url->build(['action'=>'payment', $price, $productid, $sellerid, $amount, $address, $name, $email, $phone, $state, $postcode]),
                        "method" => "post",
                    ...
                    <div class='form-row row' style="margin-top: 1rem">
                        <div class='col-xs-12 form-group required'>
                            <label class='control-label'>Name on Card</label> <input
                                class='form-control' size='4'
                                style ='height: calc(2.25rem + 15px); font-size: 1.5rem'
                                type='text'>
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-top: 1rem">
                        <div class="col-xs-12">
                            <button class="btn btn-primary btn-lg btn-block" type="submit" style="background-color: #0c5460; box-shadow: none">Pay Now ($<?= $price ?>)</button>
                        </div>
                    </div>
