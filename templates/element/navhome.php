            ...
            <div class="container-fluid">
                <div class="menu-wrapper d-flex align-items-center justify-content-between">
                    <div class="header-left d-flex align-items-center">
                        <!-- Logo -->
                        <div class="logo">
                            <a href="<?= $this->Url->build(['controller' => 'home', 'action'=>'index']); ?>"><?= $this->Html->image('logo/logo.png') ?></a>
                        </div>
                        <!-- Main-menu -->
                        <div class="main-menu  d-none d-lg-block">
                            <nav>
                                <ul id="navigation">
                                    <li><a href="<?= $this->Url->build(['controller' => 'home', 'action'=>'index']); ?>" style="color: #509F94">Home</a></li>
                    ...
                    <div class="col-12">
                        ...
                        <div class="login-box" style="position: absolute; top: -41px; right: 10px;">
                                <a style="color: #333; font-size: 30px">
