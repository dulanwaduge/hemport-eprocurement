 ...
 * @var \App\Model\Entity\Seller $product
                ...
                <div class="column-responsive column-80">
                    <div class="seller form content">
                        ...
                        <fieldset>
                            ...
                            echo "Availability";
                            echo $this->Form->select('availability',['Yes'=>'Yes','No'=>'No'], ['style' => 'margin-left:99px']);
                        ...
                        <div class="row" style="margin-left:0.8px">
                            <?php
                            echo 'Description';
                            echo $this->Form->textarea('description',['style'=>'margin-left:97px; margin-bottom:6px; width:194px']);
                            ?>
                        </div>

                        <fieldset>
                            <?php
                            echo $this->Form->control('amount',['label'=>'Quantity of Stock Available']);
                        ...
                        <div class="row" style="margin-left:0.8px">
                            ...
                            echo $this->Form->textarea('image1des',['style'=>'margin-left:38px; margin-bottom:6px; width:194px']);
                            ?>
                        </div>
