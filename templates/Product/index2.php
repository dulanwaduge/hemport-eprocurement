        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <?= $this->Form->control('key', [
                    ...
                    'placeholder'=>'Search by product name/availability'])
                ?>
                        ...
                        <div class="table-responsive">
                            <table border="3" cellspacing="0" cellpadding="3">
                                ...
                                <tr style="font-size:4">
                                    ...
                                    <th><?= $this->Paginator->sort('SellerID') ?></th>
                                ...
                                foreach ($product as $key => $product): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="actions">
                                            ...
                                            <?= $this->Html->link(__('Edit'), ['action' => 'editasadmin', $product->id],['class'=>'fas fa-edit']) ?><br>
